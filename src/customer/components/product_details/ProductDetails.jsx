        ...
        <div className="bg-white">
            <div className="pt-6">
                ...
                <section className='grid gird-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    {/* Product info */}
                    <div
                        className="lg:col-span-1 max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24"
                    >
                        <div className="lg:col-span-2 ">
                            <h1 className="text-lg lg:text-xl font-semibold text-gray-900">Universiada</h1>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <form className="mt-10">
                                ...
                                <Button variant='contained' xs={{ px: "2rem", py: "1rem", bgcolor: "#9155fd" }}>
                                    Add To Cart
                                </Button>
                            </form>
                        </div>
